...
public class SingleStateKNNMovementModel implements MovementModel {
  ...
  public SingleStateKNNMovementModel(DkeRobot robot, int kNearestNeighbors, int numberOfStatesToDiscard) {
    this.robot = robot;
